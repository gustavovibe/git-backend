...
<body style="font-family: 'Canaro', sans-serif; padding:2%">
    ...
    <div>
        <div style="text-align: center">
            <img style="width: 30%; height:30%"  src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/logo.png')))}}" alt="">
        </div>
    ...
    <div class="textG mh" style="text-align: justify;">
        ...
        <div style="text-align: center; margin: 20px;">
            <div >
                <a style="background-color: #82CF45; padding:1%; font-weight:bold; color:white; border-radius:8px; padding-left:3%; padding-right:3%;"  href="{{$data['url']}}">Reset Password</a>
            </div>
        </div>
        <br>
