    ...
    <main style="font-family: 'Montserrat', sans-serif">
        <div class="container_1" style="text-align: justify">
            <div class="presentacion text">
                <p>Estimad@ [nombre de usuario]</p>
                <p>
                    Espero que te encuentres bien. Nos ponemos en contacto contigo en
                    relación a tu curso [Nombre del Curso] en nuestra plataforma. Hemos
                    notado que has estado inactiv@ durante los últimos días, nos
                    gustaría animarte a retomar tu curso y aprovechar al máximo esta
                    valiosa oportunidad.
                </p>
            </div>
        </div>
        ...
        <div class="container_4">
            <div class="text nuestra-pagina" style="text-align: justify">
                <p>Te invitamos a continuar tu aprendizaje.</p>
                <p>¡No dejes pasar esta oportunidad de aprender y crecer!</p>
