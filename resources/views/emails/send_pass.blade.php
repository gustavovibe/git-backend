                        ...
                        <tr>
                            ...
                            <td style="width: 10%; text-align: center; vertical-align: top; padding: 0;">
                                <div class="line-container">
                                    <div class="line"></div>
                                    <img class="svg airplane-icon" src="{{ asset('images/airplane.svg') }}"
                                        alt="Icon">
                                </div>
                            </td>
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <td style="margin-left:50%;"><img
                                                src="{{ asset('images/chevron-down.svg') }}"></td>
                                    </tr>
                                </table>
                        ...
                        @foreach ($orders->flightTour->tour['accommodations'] as $accommodation)
                            @if ($accommodation['type'] == 'basePrice')
                                <tr>
                                    <td>
                                        <a
                                            style="color:#82CF45;">${{ number_format($accommodation['prices'][0]['price_per_pax'], 2) }}</a>
                                        USD x
                                        <a
                                            style="color:#82CF45;">{{ count($orders->flightTour->tour['passengers']) }}</a>
                                        adult(s)
                                    </td>
                                    <td style="text-align: right;">
                                        ${{ number_format($accommodation['prices'][0]['price_per_pax'] * count($orders->flightTour->tour['passengers']), 2) }}
                                        USD</td>
                                </tr>
                                <br>
                                ...
                                <tr>
                                    <td>
                                        <a
                                            style="color:#82CF45;">${{ number_format($accommodation['prices'][0]['price_per_pax'], 2) }}</a>
                                        USD x
                                        <a style="color:#82CF45;">{{ $accommodation['prices'][0]['pax_count'] }}</a>
                                        single
                                    </td>
                                    <td style="text-align: right;">
                                        ${{ number_format($accommodation['prices'][0]['price_per_pax'] * $accommodation['prices'][0]['pax_count'], 2) }}
                                        USD</td>
                                </tr>
                            @endif
                        @endforeach
                ...
                <div style="padding: 1%;">
                    <div class="laterald">
                        <table style="width: 100%;margin-left:2%;">
                            <tr>
                                <td>
                                    <p style="color:gray;font-size:10px;">Total price of the trip including all taxes
                                        and fees</p>
                                </td>
                                <td style="text-align: right;">
                ...
                <table style="width: 100%;">
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align:right;">
                                ${{ number_format($orders->flightTour->tour['total_value'], 2) }} USD</td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <td></td>
                        <td style="color:#82CF45;">Total</td>
                        <td style="color:#82CF45;text-align:right;">
                            ${{ number_format($orders->flightTour->tour['total_value'], 2) }} USD</td>
                    </tfoot>
                </table>
            </div>
                ...
                <div>
                    <table class="card">
                        <tr>
                            <td>
                                <div>
                                    <img id="img_" src="{{ asset('images/transfer.svg') }}">
                                    <h5>Airport transfer</h5>
                                    <p style="width:100%">Airport transfers not included adventure?</p>
                                    <a>Go somewhere <img id="iconic"
                                            src="{{ asset('images/box-arrow-up-right.svg') }}"> </a>

                                </div>
                            </td>
                            <td>
                                <div>
                                    <img id="img_" src="{{ asset('images/insurance.svg') }}">
                                    <h5>Insurance</h5>
                            ...
                            <td>
                                <div>
                                    <img id="img_" src="{{ asset('images/accommodation.svg') }}">
                                    <h5>Accommodation</h5>
                            ...
                            <td>
                                <div>
                                    <img id="img_" src="{{ asset('images/activities.svg') }}">
                                    <h5>Activities</h5>
            ...
            <div>
                <table width="100%">
                    <tr>
                        ...
                        <td style="text-align: right;">
                            <img src="{{ asset('images/trust-index.png') }}" alt="">
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div>
                <table width="100%">
                    <tr>
                        ...
                        <td style="text-align: right;">
                            <img src="{{ asset('images/face-icon.png') }}">
                            <img src="{{ asset('images/insta-icon.png') }}">
