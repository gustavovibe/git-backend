...
<body>
    ...
    <main style="font-family: 'Montserrat', sans-serif">
        ...
        <div class="container_2">
            <div class="cursos">
                <p class="text">
                    Es un placer saludarte. Gracias por tu interés en inscribirte a
                    nuestra plataforma.
                </p>
                <p class="text">
                    Email: {{ $email }}
                ...
                <p class="text">
                    Mientras tanto, si tienes alguna pregunta o necesitas información
                    adicional, no dudes en ponerte en contacto con nosotros.
                </p>
            </div>
            <div style="text-align: center; margin-top: 50px" class="text">
                Estamos ansiosos por acompañarte en tu proceso de aprendizaje.
                <p style="font-weight: bold">¡Bienvenido a nuestra comunidad!</p>
            </div>
        </div>
