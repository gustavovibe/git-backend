...
<body>
    ...
    <main style="font-family: 'Montserrat', sans-serif">
        ...
        <div class="container_2">
            <div class="cursos">
                <p class="text">
                    Es un placer saludarte. Gracias por tu interés en inscribirte a nuestra certificación {{ $certification }}.
                </p>
                <p class="text">
                    Queremos informarte que tu solicitud de inscripción ha sido recibida con éxito. Pronto te enviaremos un segundo correo electrónico que contendrá los detalles necesarios para acceder a la plataforma de capacitación.
                </p>
                <p class="text">
                    Mientras tanto, si tienes alguna pregunta o necesitas información adicional, no dudes en ponerte en contacto con nosotros.
                </p>
            </div>
            <div style="text-align: center; margin-top: 50px" class="text">
                Estamos muy emocionados de acompañarte en tu proceso de aprendizaje.
                <p style="font-weight: bold">¡Te damos la bienvenida a nuestra comunidad!</p>
            </div>
        </div>
