...
<head>
    ...
    <style>
          .column {
            ...
            width: 80%; /* Ajusta el tamaño del ancho */
            height: 80%;
            }
            .tDesc b{
                border-style:solid;
         ...
         /*    .foot svg{
            ...
            flex-wrap: wrap; /* Ensures that the icons wrap to the next line if there's no enough space */
            }

            .social-icons svg {
            width: 24px; /* Adjust the size of the icons */
            height: 24px; /* Adjust the size of the icons */
            }
        ...
        .icon {
            ...
            top: 50%;
            left: 50%;
            transform: translate(-70%, -70%) rotate(180deg); /* Rotate the icon to point down */
            font-size: 24px;
        }
    </style>
</head>
<body style="font-family: 'Canaro', sans-serif;">
    ...
    <br>
    <div class="t1 ">
        <label class="Tcolor">Your trip has been booked successfully! Confirmation <b>#:109-404-387</b> </label>
    </div>
    <br>
    <div class="textG mh">
        <h1>Bon voyage, <a class="Tcolor">Sophia!</a></h1>
        ...
        <ul>
            ...
            <li>You can also contact us, view and make changes to your booking inside the <u class="Tcolor">Travelers' portal</u> </li>
        </ul>
    </div>
    <br>
    <div class="tGroup mh">
    ...
    <div class="tDesc Borderg mh">
        <div class="row">
            <div class="column" style="width: 40%;">
                <img src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/22/80/0f/ca/caption.jpg?w=1400&h=1400&s=1">
            </div>
            <div class="column">
                <h3 class="Tcolor">Best of Southern Spain</h3>
                <p><svg style="color: orange;" styeclass=" w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-width="2" d="M11.083 5.104c.35-.8 1.485-.8 1.834 0l1.752 4.022a1 1 0 0 0 .84.597l4.463.342c.9.069 1.255 1.2.556 1.771l-3.33 2.723a1 1 0 0 0-.337 1.016l1.03 4.119c.214.858-.71 1.552-1.474 1.106l-3.913-2.281a1 1 0 0 0-1.008 0L7.583 20.8c-.764.446-1.688-.248-1.474-1.106l1.03-4.119A1 1 0 0 0 6.8 14.56l-3.33-2.723c-.698-.571-.342-1.702.557-1.771l4.462-.342a1 1 0 0 0 .84-.597l1.753-4.022Z"/>
                  </svg>
                   <b class="Tcolor">4.58</b> 54 reviews</p>
                <div class="row">
                    <div class="col">
                        <p><svg class="Tcolor w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m17 16-4-4 4-4m-6 8-4-4 4-4"/>
                          </svg>
                          Starts in: Madrid, Spain</p>
                        <p><svg  class="Tcolor w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 10h16M8 14h8m-4-7V4M7 7V4m10 3V4M5 20h14a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Z"/>
                          </svg>
                          Starts on: Nov 11, 2023</p>
                        <p><svg class="Tcolor w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <div class="col">
                        <p><svg class="Tcolor w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                          ...
                          Ends in: Barcelona, Spain</p>
                        <p><svg class="Tcolor w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 10h16M8 14h8m-4-7V4M7 7V4m10 3V4M5 20h14a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Z"/>
                          </svg>
                          Ends  on: Nov 22, 2023</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="fGroup Borderg mh">
        <div class="ffGroup">
            <label class="Tcolor">Warsaw <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5m14 0-4 4m4-4-4-4"/>
              </svg>
               Mexico City</label>
            <a><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
              </svg>
              21h 55m</a>
        </div>
            ...
            <div class="row" style="padding: 1%;">
                ...
                <div class="column">
                    <div class="line-container">
                        <div class="line"></div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="icon bi bi-airplane-engines-fill" viewBox="0 0 16 16">
                ...
                <div class="column">
                    <label class="Tcolor"> Warsaw WAW</label>
                    <p>Warsaw Chopin</p>
                    <h4>Wizz Air</h4>
                    <label class="Tcolor">Madrid MAD</label>
                    <p>Adolfo Suarez Madrid-Barajas</p>
                </div>
                <div class="column">
                    <a style="color: #82CF45;font-weight:bold;"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <br>
        <div class="Tscolor">
            <label ><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
              </svg>
    ...
    <div class="Borderg mh" style="padding: 1%;">
        ...
        <div>
            <table class="t1">
                <tbody>
                    <tr>
                        <td><a>$1,099</a> USD x <a>2</a> adults</td>

                        <td>$1,398 USD</td>
                    </tr>
                    <tr>
                        <td><a>$699</a> USD x <a>2</a> children</td>
                        <td>$1,398 USD</td>
                    </tr>
                    <tr>
                        <td><a>$699</a> USD x <a>2</a> infants</td>
                        <td>$1,398 USD</td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="Recomend mh">
        ...
        <div class="card-container">
            <div class="card">
                <img class="card-img-top" src="{{ asset('images/airport.svg') }}">
                <div class="card-body">
            ...
            <div class="card">
                <img class="card-img-top" src="{{ asset('images/insurance.svg') }}">
                <div class="card-body">
            ...
            <div class="card">
                <img class="card-img-top"  src="{{ asset('images/accommodation.svg') }}">
                <div class="card-body">
            ...
            <div class="card">
                <img class="card-img-top"  src="{{ asset('images/activities.svg') }}">
                <div class="card-body">
...
<div class="foot">
    <div class="card-container">
        ...
        <div id="el">
            <h5>Supporting</h5>
            <img id="sp" src="{{ asset('images/united.jpeg') }}" alt="">
            <img id="sp" src="{{ asset('images/future.jpeg') }}" alt="">
            <img id="sp" src="{{ asset('images/adventure.jpeg') }}" alt="">
        </div>
        <div id="el">
            <div>
                <h5>Follow Us</h5>
                <div class="social-icons">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                      </svg>
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                        <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                      </svg>
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" fill="currentColor" class="bi bi-pinterest" viewBox="0 0 16 16">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16">
            ...
            <div>
                ...
                <img id="pay" src="{{ asset('images/pay_methods.jpeg') }}" alt="">
            </div>
        </div>
